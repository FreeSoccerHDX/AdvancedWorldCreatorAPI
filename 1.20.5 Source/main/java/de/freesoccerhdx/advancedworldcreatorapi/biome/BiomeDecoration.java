...
public class BiomeDecoration {
    ...
    public static final BiomeDecoration WILDFLOWERS_MEADOW = new BiomeDecoration("minecraft", "wildflowers_meadow");
    ...
    public static final BiomeDecoration FANCY_OAK_LEAF_LITTER = new BiomeDecoration("minecraft", "fancy_oak_leaf_litter");
    public static final BiomeDecoration BLUE_ICE = new BiomeDecoration("minecraft", "blue_ice");
    public static final BiomeDecoration FALLEN_SUPER_BIRCH_TREE = new BiomeDecoration("minecraft", "fallen_super_birch_tree");
    ...
    public static final BiomeDecoration END_PLATFORM = new BiomeDecoration("minecraft", "end_platform");
    ...
    public static final BiomeDecoration PALE_OAK_CHECKED = new BiomeDecoration("minecraft", "pale_oak_checked");
    ...
    public static final BiomeDecoration TREES_BIRCH_AND_OAK_LEAF_LITTER = new BiomeDecoration("minecraft", "trees_birch_and_oak_leaf_litter");
    ...
    public static final BiomeDecoration PATCH_DRY_GRASS_DESERT = new BiomeDecoration("minecraft", "patch_dry_grass_desert");
    public static final BiomeDecoration PATCH_PUMPKIN = new BiomeDecoration("minecraft", "patch_pumpkin");
    public static final BiomeDecoration FLOWER_PALE_GARDEN = new BiomeDecoration("minecraft", "flower_pale_garden");
    ...
    public static final BiomeDecoration BIRCH_LEAF_LITTER = new BiomeDecoration("minecraft", "birch_leaf_litter");
    ...
    public static final BiomeDecoration PATCH_LEAF_LITTER = new BiomeDecoration("minecraft", "patch_leaf_litter");
    ...
    public static final BiomeDecoration FALLEN_BIRCH_TREE = new BiomeDecoration("minecraft", "fallen_birch_tree");
    ...
    public static final BiomeDecoration FANCY_OAK_BEES_0002_LEAF_LITTER = new BiomeDecoration("minecraft", "fancy_oak_bees_0002_leaf_litter");
    ...
    public static final BiomeDecoration PALE_MOSS_PATCH = new BiomeDecoration("minecraft", "pale_moss_patch");
    ...
    public static final BiomeDecoration DARK_OAK_LEAF_LITTER = new BiomeDecoration("minecraft", "dark_oak_leaf_litter");
    public static final BiomeDecoration ORE_LAPIS = new BiomeDecoration("minecraft", "ore_lapis");
    public static final BiomeDecoration ORE_DIAMOND_MEDIUM = new BiomeDecoration("minecraft", "ore_diamond_medium");
    public static final BiomeDecoration SEAGRASS_COLD = new BiomeDecoration("minecraft", "seagrass_cold");
    public static final BiomeDecoration OAK_BEES_0002_LEAF_LITTER = new BiomeDecoration("minecraft", "oak_bees_0002_leaf_litter");
    public static final BiomeDecoration ICEBERG_BLUE = new BiomeDecoration("minecraft", "iceberg_blue");
    public static final BiomeDecoration PATCH_FIREFLY_BUSH_SWAMP = new BiomeDecoration("minecraft", "patch_firefly_bush_swamp");
    public static final BiomeDecoration ORE_MAGMA = new BiomeDecoration("minecraft", "ore_magma");
    public static final BiomeDecoration PATCH_FIREFLY_BUSH_NEAR_WATER_SWAMP = new BiomeDecoration("minecraft", "patch_firefly_bush_near_water_swamp");
    public static final BiomeDecoration TREES_WATER = new BiomeDecoration("minecraft", "trees_water");
    public static final BiomeDecoration PATCH_BUSH = new BiomeDecoration("minecraft", "patch_bush");
    public static final BiomeDecoration FREEZE_TOP_LAYER = new BiomeDecoration("minecraft", "freeze_top_layer");
    public static final BiomeDecoration FALLEN_SPRUCE_TREE = new BiomeDecoration("minecraft", "fallen_spruce_tree");
    ...
    public static final BiomeDecoration PALE_OAK_CREAKING_CHECKED = new BiomeDecoration("minecraft", "pale_oak_creaking_checked");
    ...
    public static final BiomeDecoration WILDFLOWERS_BIRCH_FOREST = new BiomeDecoration("minecraft", "wildflowers_birch_forest");
    ...
    public static final BiomeDecoration TREES_CHERRY = new BiomeDecoration("minecraft", "trees_cherry");
    ...
    public static final BiomeDecoration PATCH_FIREFLY_BUSH_NEAR_WATER = new BiomeDecoration("minecraft", "patch_firefly_bush_near_water");
    public static final BiomeDecoration PATCH_DRY_GRASS_BADLANDS = new BiomeDecoration("minecraft", "patch_dry_grass_badlands");
    public static final BiomeDecoration PALE_GARDEN_FLOWERS = new BiomeDecoration("minecraft", "pale_garden_flowers");
    public static final BiomeDecoration PATCH_GRASS_MEADOW = new BiomeDecoration("minecraft", "patch_grass_meadow");
    ...
    public static final BiomeDecoration PALE_GARDEN_VEGETATION = new BiomeDecoration("minecraft", "pale_garden_vegetation");
    ...
    public static final BiomeDecoration BIRCH_BEES_0002_LEAF_LITTER = new BiomeDecoration("minecraft", "birch_bees_0002_leaf_litter");
    public static final BiomeDecoration WARM_OCEAN_VEGETATION = new BiomeDecoration("minecraft", "warm_ocean_vegetation");
    public static final BiomeDecoration FLOWER_CHERRY = new BiomeDecoration("minecraft", "flower_cherry");
    public static final BiomeDecoration FLOWER_FOREST_FLOWERS = new BiomeDecoration("minecraft", "flower_forest_flowers");
    public static final BiomeDecoration FALLEN_OAK_TREE = new BiomeDecoration("minecraft", "fallen_oak_tree");
    public static final BiomeDecoration TREES_WINDSWEPT_SAVANNA = new BiomeDecoration("minecraft", "trees_windswept_savanna");
    public static final BiomeDecoration FALLEN_JUNGLE_TREE = new BiomeDecoration("minecraft", "fallen_jungle_tree");
    ...
    public static final BiomeDecoration OAK_LEAF_LITTER = new BiomeDecoration("minecraft", "oak_leaf_litter");
    ...
    public static final BiomeDecoration CHERRY_BEES_005 = new BiomeDecoration("minecraft", "cherry_bees_005");
    ...
    public static final BiomeDecoration CHERRY_CHECKED = new BiomeDecoration("minecraft", "cherry_checked");
    ...
    public BiomeDecoration(NamespacedKey key) {
        ...
        WritableRegistry<PlacedFeature> placedFeatureRegistry = NMSHelper.getWritableRegistry(Registries.PLACED_FEATURE);

        // create a file with the name of the key as java format: 'public static final BiomeDecoration WARPED_FUNGI = new BiomeDecoration("minecraft", "warped_fungi");'
        // and write the key into the file
        try {
            File file = new File(AdvancedWorldCreatorAPI.main.getDataFolder(), "BiomeDecoration.txt");
            ...
            for (ResourceLocation decorationLoc : placedFeatureRegistry.keySet()) {
                writer.write("public static final BiomeDecoration " + decorationLoc.getPath().toUpperCase() + " = new BiomeDecoration(\"" + decorationLoc.getNamespace() + "\", \"" + decorationLoc.getPath() + "\");\n");
            }
        ...
        Optional<PlacedFeature> optional = placedFeatureRegistry.getOptional(ResourceLocation.fromNamespaceAndPath(key.getNamespace(), key.getKey()));
        if(optional.isEmpty()) {
        ...
        //feature = Registries.PLACED_FEATURE.get(ResourceLocation.fromNamespaceAndPath(name().toLowerCase(Locale.ROOT)));
    }
