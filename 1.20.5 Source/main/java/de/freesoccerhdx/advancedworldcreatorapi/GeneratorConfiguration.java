...
public class GeneratorConfiguration implements Keyed {
    ...
    public GeneratorConfiguration(NamespacedKey namespacedKey) {
        ...
        //ResourceLocation resourceLocation = ResourceLocation.fromNamespaceAndPath(namespacedKey.getNamespace(), namespacedKey.getKey());
        ResourceKey<NoiseGeneratorSettings> generatorSettingBaseResourceKey = NMSHelper.createResourceKey(Registries.NOISE_SETTINGS, namespacedKey);//ResourceKey.create(Registries.NOISE_SETTINGS, resourceLocation);
        ...
        // TODO: Test update 1.20.1 -> 1.20.3
        Holder.Reference<NoiseGeneratorSettings> referenceNoiseGen = NMSHelper.getHolderReferenceByResourceKey(Registries.NOISE_SETTINGS, generatorSettingBaseResourceKey); // registryGeneratorSettings.get(generatorSettingBaseResourceKey);
        if(referenceNoiseGen.isBound()) {
            NoiseGeneratorSettings ngs = referenceNoiseGen.value();
