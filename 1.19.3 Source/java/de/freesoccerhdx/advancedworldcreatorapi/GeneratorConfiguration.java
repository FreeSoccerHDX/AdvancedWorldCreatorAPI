...
public class GeneratorConfiguration implements Keyed {
    ...
    public GeneratorConfiguration(NamespacedKey namespacedKey) {
        ...
        WritableRegistry<NoiseGeneratorSettings> registryGeneratorSettings = (WritableRegistry<NoiseGeneratorSettings>) craftServer.getHandle().getServer().registryAccess().registryOrThrow(Registries.NOISE_SETTINGS);
