    ...
    public static class Builder{
        ...
        public BiomeProviderDefault create(){
            ...
            return new BiomeProviderDefault() {
                ...
                private BiomeSource biomeSource = presetBiomes == PresetBiomes.OVERWORLD ? MultiNoiseBiomeSource.Preset.OVERWORLD.biomeSource(biomeHolderGetter, true) : MultiNoiseBiomeSource.Preset.NETHER.biomeSource(biomeHolderGetter,true);
