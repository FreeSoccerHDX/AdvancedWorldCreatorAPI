...
public class OverworldBiomeGenerator extends WorldChunkManager{
	...
	public static class CREATOR {
		...
		public OverworldBiomeGenerator create() {
		 ...
		 public CREATOR overwriteBiome(Biome target, Biome newbiome) {
			 return overwriteBiome(AdvancedWorldCreatorAPI.getNMSBiome(target), AdvancedWorldCreatorAPI.getNMSBiome(newbiome));
		 }
		
		 public CREATOR overwriteBiome(Biome target, RegisteredCustomBiome newbiome) {
			 return overwriteBiome(AdvancedWorldCreatorAPI.getNMSBiome(target), newbiome);
		 }
