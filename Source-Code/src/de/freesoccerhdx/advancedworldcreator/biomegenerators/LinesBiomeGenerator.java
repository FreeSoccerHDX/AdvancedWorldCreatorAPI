...
public class LinesBiomeGenerator extends WorldChunkManager{
	...
	public static class CREATOR {
		...
		public CREATOR(int chunksize, boolean xdirection) {
			csize = chunksize;
			xdir = xdirection;
		...
		public LinesBiomeGenerator create() {
			if(biomelist.size() > 0) {
				return new LinesBiomeGenerator(biomelist, csize, xdir);
			}
			return null;
		}
	...
	private LinesBiomeGenerator(ArrayList<Supplier<BiomeBase>> list, int biomesize, boolean xdirection) {
		super(list.stream());
