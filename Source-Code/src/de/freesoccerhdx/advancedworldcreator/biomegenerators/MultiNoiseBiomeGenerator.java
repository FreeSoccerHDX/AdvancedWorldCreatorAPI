...
public class MultiNoiseBiomeGenerator extends WorldChunkManager {
	  ...
	  // private final MultiNoiseBiomeGenerator.aa h; not used
	   ...
	   //   this.k = var6;
	      try {
	    	  double[] doubles1 = new double[var3.c_list.size()];
	    	  double[] doubles2 = new double[var4.c_list.size()];
	    	  double[] doubles3 = new double[var5.c_list.size()];
	    	  double[] doubles4 = new double[var6.c_list.size()];
	    	  
	    	  for(int i = 0; i < var3.c_list.size(); i++) {
	    		  doubles1[i] = var3.c_list.get(i);
	    	  }
	    	  for(int i = 0; i < var4.c_list.size(); i++) {
	    		  doubles2[i] = var4.c_list.get(i);
	    	  }
	    	  for(int i = 0; i < var5.c_list.size(); i++) {
	    		  doubles3[i] = var5.c_list.get(i);
	    	  }
	    	  for(int i = 0; i < var6.c_list.size(); i++) {
	    		  doubles4[i] = var6.c_list.get(i);
	    	  }
	    	  
	    	  this.l = NoiseGeneratorNormal.a(new SeededRandom(var0), var3.a(), doubles1);
	    	  this.m = NoiseGeneratorNormal.a(new SeededRandom(var0+1), var4.a(), doubles2);
	    	  this.n = NoiseGeneratorNormal.a(new SeededRandom(var0+2), var5.a(), doubles3);
	    	  this.o = NoiseGeneratorNormal.a(new SeededRandom(var0+3), var6.a(), doubles4);
	    	  
	    	  /*
	    	  try {
	    		  
	    		  
	    		  this.l = NoiseGeneratorNormal.a(new SeededRandom(var0), var3.a(), new org.bukkit.craftbukkit.libs.it.unimi.dsi.fastutil.doubles.DoubleArrayList(var3.c_list));
		    	  this.m = NoiseGeneratorNormal.a(new SeededRandom(var0+1), var4.a(), new org.bukkit.craftbukkit.libs.it.unimi.dsi.fastutil.doubles.DoubleArrayList(var4.c_list));
		    	  this.n = NoiseGeneratorNormal.a(new SeededRandom(var0+2), var5.a(), new org.bukkit.craftbukkit.libs.it.unimi.dsi.fastutil.doubles.DoubleArrayList(var5.c_list));
		    	  this.o = NoiseGeneratorNormal.a(new SeededRandom(var0+3), var6.a(), new org.bukkit.craftbukkit.libs.it.unimi.dsi.fastutil.doubles.DoubleArrayList(var6.c_list));
	    		  
	    	  }catch(NoClassDefFoundError error) {
	    		  
	    		  this.l = NoiseGeneratorNormal.a(new SeededRandom(var0), var3.a(), new it.unimi.dsi.fastutil.doubles.DoubleArrayList(var3.c_list));
		    	  this.m = NoiseGeneratorNormal.a(new SeededRandom(var0+1), var4.a(), new it.unimi.dsi.fastutil.doubles.DoubleArrayList(var4.c_list));
		    	  this.n = NoiseGeneratorNormal.a(new SeededRandom(var0+2), var5.a(), new it.unimi.dsi.fastutil.doubles.DoubleArrayList(var5.c_list));
		    	  this.o = NoiseGeneratorNormal.a(new SeededRandom(var0+3), var6.a(), new it.unimi.dsi.fastutil.doubles.DoubleArrayList(var6.c_list));
	    	  }
	    	  */
	...
	public BiomeBase getBiome(int var0, int var1, int var2) {
	   ...
	   public static class CREATOR {
		   ...
		   public CREATOR addBiome(Biome biome, float temperature_noise, float humidity, float altitude, float weirdness, float offset) {
			   return addBiome(AdvancedWorldCreatorAPI.getNMSBiome(biome),temperature_noise, humidity, altitude, weirdness, offset);
		   }
