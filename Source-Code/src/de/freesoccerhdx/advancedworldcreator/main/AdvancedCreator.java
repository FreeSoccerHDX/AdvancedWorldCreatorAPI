...
public class AdvancedCreator {
	...
	private List<WorldDecoration> blacklist_deco = new ArrayList<>();
	private EnumGamemode gamemode = EnumGamemode.a;
	private EnumDifficulty enumdifficulty = EnumDifficulty.b;
	
	private BlockData topbedrock = Material.BEDROCK.createBlockData();
	private BlockData bottombedrock = Material.BEDROCK.createBlockData();
	...
	private boolean generatingterrain = true;
	...
	public void generateTerrain(boolean isgenerating) {
		generatingterrain = isgenerating;
	}
	
	public boolean isGeneratingTerrain() {
		return generatingterrain;
	}
	...
	public List<WorldDecoration> getBlacklistedDecoration(){
		return blacklist_deco;
	}
	public boolean isDecorationBlacklisted(WorldDecoration dec) {
		return blacklist_deco.contains(dec);
	}
	public void setDecorationBlacklisted(WorldDecoration dec, boolean b) {
		if(b) {
	...
	public void setCustomWorldSetting(NoiseSettings noisesettings, BlockData solid_material, BlockData fluid_material, int bedrock_roof_position, int bedrock_floor_position, int sea_level,
	...
	//	int min_surface_level, boolean disable_mob_generation, boolean aquifers_enabled, boolean noise_caves_enabled, boolean deepslate_enabled, boolean ore_veins_enabled, boolean noodle_caves_enabled) {
		...
		try {
	        ...
	        CraftBlockData cbd_solid = (CraftBlockData) solid_material;
	        CraftBlockData cbd_fluid = (CraftBlockData) fluid_material;
	        ...
	        gsb = constructor.newInstance(new StructureSettings(true),noisesettings,cbd_solid.getState(),cbd_fluid.getState(),bedrock_roof_position,bedrock_floor_position,sea_level,
	...
	public BlockData getTopBedrock() {
		return this.topbedrock;
	}
	public void setTopBedrock(BlockData block) {
		this.topbedrock = block;
	}
	
	public BlockData getBottomBedrock() {
		return this.bottombedrock;
	}
	public void setBottomBedrock(BlockData block) {
	...
	public boolean hasCustomChunkCreator() {
		return chunkcreator != null;
	}
	public void setCustomChunkCreator(ChunkCreator cc) {
		chunkcreator = cc;
	}
	public ChunkCreator getCustomChunkCreator() {
		return chunkcreator;
	}
	
	public static abstract class ChunkCreator {
		
		
		
		public abstract boolean generateChunk(NewDummyChunkGeneratorAbstract chunkGenerator, Executor executor, StructureManager structuremanager, IChunkAccess ichunkaccess);
