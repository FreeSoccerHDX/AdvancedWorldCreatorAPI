...
public class CustomMegaPineTreeStructure extends CustomTree{
	...
	private int leave_height_spread = 7;
	...
	public CustomMegaPineTreeStructure(String name) {
		this(name,null,null);
	}
	

	public CustomMegaPineTreeStructure(String name,Block woodmaterial, Block leavesmaterial) {
		this.name = name;
