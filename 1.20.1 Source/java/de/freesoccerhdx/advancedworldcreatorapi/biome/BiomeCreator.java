...
public class BiomeCreator implements Keyed {
    ...
    public CustomBiome createBiome(boolean replace) {
        ...
        ResourceKey<Biome> resourceKey = NMSHelper.createResourceKey(getKey(), Registries.BIOME);
        ...
        if(optionalBiome.isEmpty()) {
            NMSHelper.registerToRegistry(getKey(), createdBiomeBase, Registries.BIOME);
            /*
